...
/// </summary>
public class MapWhenSyncMiddleware<TRequestContext> where TRequestContext : class, IRequestContext
{
    private readonly SyncRequestDelegate<TRequestContext> _next;
    private readonly MapWhenSyncOptions<TRequestContext> _options;

    /// <summary>
    /// Creates a new instance of <see cref="MapWhenSyncMiddleware{TRequestContext}"/>.
    /// </summary>
    /// <param name="next">The delegate representing the next middleware in the request pipeline.</param>
    /// <param name="options">The middleware options.</param>
    public MapWhenSyncMiddleware(SyncRequestDelegate<TRequestContext> next, MapWhenSyncOptions<TRequestContext> options)
    {
    ...
    public void Invoke(TRequestContext context)
    {
