...
/// <summary>
/// Options for the <see cref="MapWhenSyncMiddleware{TRequestContext}"/>.
/// </summary>
public class MapWhenSyncOptions<TRequestContext> where TRequestContext : class, IRequestContext
{
    ...
    /// </summary>
    public SyncRequestDelegate<TRequestContext>? Branch { get; set; }
}