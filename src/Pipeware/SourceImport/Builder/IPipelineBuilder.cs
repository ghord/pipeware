...
/// </summary>
public interface IPipelineBuilder<TRequestContext> where TRequestContext : class, IRequestContext
{
    /// <summary>
    ...
    /// <returns>The <see cref="IPipelineBuilder{TRequestContext}"/>.</returns>
    IPipelineBuilder<TRequestContext> Use(Func<RequestDelegate<TRequestContext>, RequestDelegate<TRequestContext>> middleware);

    /// <summary>
    /// Creates a new <see cref="IPipelineBuilder{TRequestContext}"/> that shares the <see cref="Properties"/> of this
    /// <see cref="IPipelineBuilder{TRequestContext}"/>.
    /// </summary>
    /// <returns>The new <see cref="IPipelineBuilder{TRequestContext}"/>.</returns>
    IPipelineBuilder<TRequestContext> New();

    /// <summary>
    /// Builds the delegate used by this application to process HTTP requests.
    /// </summary>
    /// <returns>The request handling delegate.</returns>
    RequestDelegate<TRequestContext> Build();
}