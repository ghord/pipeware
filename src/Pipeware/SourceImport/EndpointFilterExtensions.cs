...
public static partial class EndpointFilterExtensions
{
    ...
    public static IEndpointConventionBuilder<TRequestContext> AddEndpointFilter< TRequestContext>(this IEndpointConventionBuilder<TRequestContext> builder, IEndpointFilter<TRequestContext> filter)  where TRequestContext : class, IRequestContext =>
    ...
    /// <returns>A <see cref="RouteHandlerBuilder{TRequestContext}"/> that can be used to further customize the route handler.</returns>
    public static IEndpointConventionBuilder<TRequestContext> AddEndpointFilter< TRequestContext>(this IEndpointConventionBuilder<TRequestContext> builder, Func<EndpointFilterInvocationContext<TRequestContext>, EndpointFilterDelegate<TRequestContext>, ValueTask<object?>> routeHandlerFilter)
 where TRequestContext : class, IRequestContext
    ...
    /// <returns>A <see cref="RouteHandlerBuilder{TRequestContext}"/> that can be used to further customize the route handler.</returns>
    public static IEndpointConventionBuilder<TRequestContext> AddEndpointFilterFactory< TRequestContext>(this IEndpointConventionBuilder<TRequestContext> builder, Func<EndpointFilterFactoryContext, EndpointFilterDelegate<TRequestContext>, EndpointFilterDelegate<TRequestContext>> filterFactory)
 where TRequestContext : class, IRequestContext
    {
