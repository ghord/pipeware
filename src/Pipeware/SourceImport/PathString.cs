...
// Source file: https://github.com/dotnet/aspnetcore/tree/release/8.0/src/Http/Http.Abstractions/src/PathString.cs
// Source Sha256: 485f99b4cda809b1ae51404813ce18108d09f25c
...
public readonly struct PathString : IEquatable<PathString>
{
    ...
    public PathString(string? value)
    {
        ...
        {
            throw new ArgumentException(string.Format("The path in '{0}' must start with '/'.", nameof(value)), nameof(value));
        }
        Value = value;
    }
