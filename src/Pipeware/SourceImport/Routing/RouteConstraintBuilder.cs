...
// Source file: https://github.com/dotnet/aspnetcore/tree/release/8.0/src/Http/Routing/src/RouteConstraintBuilder.cs
// Source Sha256: 59d334d043489baf70463e04203945981fd7fc44
...
string.Format("The constraint entry '{0}' - '{1}' on the route '{2}' must have a string value or be of a type which implements '{3}'.", key, value, _displayName, typeof(IRouteConstraint)));
            }
...
string.Format("The constraint entry '{0}' - '{1}' on the route '{2}' could not be resolved by the constraint resolver of type '{3}'.", key, constraintText, _displayName, _inlineConstraintResolver.GetType().Name));
        }
