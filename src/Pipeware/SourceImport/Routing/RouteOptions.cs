...
// Source file: https://github.com/dotnet/aspnetcore/tree/release/8.0/src/Http/Routing/src/RouteOptions.cs
// Source Sha256: 07c8a9da09dc79af2e04e1a757647a658f67c1bd
...
/// </summary>
public class RouteOptions<TRequestContext> where TRequestContext : class, IRequestContext
#else
...
#endif
{
...
#if !COMPONENTS
    private ICollection<EndpointDataSource<TRequestContext>> _endpointDataSources = default!;

    /// <summary>
    /// Gets a collection of <see cref="EndpointDataSource{TRequestContext}"/> instances configured with routing.
    /// </summary>
    internal ICollection<EndpointDataSource<TRequestContext>> EndpointDataSources
    {
        get
        {
    ...
    {
        [RequiresUnreferencedCode($"The linker cannot determine what constraints are being added via the ConstraintMap property. Prefer {nameof(RouteOptions<TRequestContext>)}.{nameof(SetParameterPolicy)} instead for setting constraints. This warning can be suppressed if this property is being used to read or delete constraints.")]
        get
        {
