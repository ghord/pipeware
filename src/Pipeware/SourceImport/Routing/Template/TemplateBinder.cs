...
// Source file: https://github.com/dotnet/aspnetcore/tree/release/8.0/src/Http/Routing/src/Template/TemplateBinder.cs
// Source Sha256: 74d8bfef6ced1235838e1a514f1b522aea76355d
...
public class TemplateBinder
{
    ...
    public bool TryProcessConstraints(IRequestContext? requestContext, RouteValueDictionary combinedValues, out string? parameterName, out IRouteConstraint? constraint)
    {
        ...
        for (var i = 0; i < constraints.Length; i++)
        {
            ...
            if (!constraint.Match(requestContext, NullRouter.Instance, parameterName, combinedValues, RouteDirection.UrlGeneration))
            {
                return false;
            }
        }
